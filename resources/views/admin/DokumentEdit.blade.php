...
<section class="content">
    <div class="container-fluid col-md-6">
        <div class="card card-default">
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{url('/dokument/update/'.$berkasas->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Pegawai</label>
                                <input type="text" name="kd_berkas" value="{{$berkasas->kd_berkas}}" class="form-control">
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                    ...
                    <div>
                        <a href="{{url('/dokument/index/')}}" class="btn btn-danger">Batal</a>
